...
namespace Tests\Full\CuyzVelinorDto\Address;
...
class AddressClean
{
    ...
    /** @var string|null Площадь квартиры */
    ...
    /** @var null|string Уровень детализации, до которого адрес найден в ФИАС */
    public ?string $fias_level;

    /** @var null|string Код КЛАДР */
    public ?string $kladr_id;

    /** @var null|string Является ли город центром */
    ...
    /** @var null|string Координаты: широта */
    public ?string $geo_lat;

    /** @var null|string Координаты: долгота */
